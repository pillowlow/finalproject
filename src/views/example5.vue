          ...
          <el-container id="wordblock1-02">
            ...
            <el-container >
              ...
              <el-main class="containerblock " style="padding: 0 0.3rem  0 0.3rem ">
                <h5>  遊戲製作!!</h5 >
                <h6>
                  &emsp; 「魔女的贗品」預計是一款主打探索與劇情解謎的2D惡魔城式冒險遊戲。類似定位的知名遊戲有像是 「Hollow Knight(空洞騎士) 」 
                  ， 「Salt and Sanctuary(鹽與聖所)」這幾款(都是窩們的偶像 @_@)。基本上，這類遊戲最主要的賣點不外乎精緻的地圖，龐大，可供
                  玩家慢慢挖掘的複雜劇情。屬於喜歡的人就會喜歡，不喜歡的人也會喜歡同人圖的類型。
                      我是專案主要的召集人和唯一的技術美術，負責場景，原畫，動畫，特效，，Csharp腳本撰寫，企劃和文本撰寫等等
            ...
            <el-footer class="containerblock " height="1.5rem" style="border-radius: 0 0 0.4rem 0.4rem ;padding: 0 0.3rem  0 0.3rem">
              <h6>
                <a target="_blank" href="https://www.youtube.com/watch?v=lUNoJ-OrMbM&feature=youtu.be"
                   style="color:white;font-size: 0.1rem;margin-top: 0.1rem;position: absolute">
                  <span >很菜的宣傳影片@@ 音樂到美術資源全自製</span>
                </a>
              </h6>
...
#logo-02{
  background-image: url("../assets/webexamole.jpg");
  float: left;
  position: relative;
  width: 1.7rem;
  height: 1.7rem;
